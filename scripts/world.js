...
export const WORLD_DATA = {
  town: {
    ...
    exits: [
      ...
      { x: 20, y: 260, w: 170, h: 170, to: 'west', spawn: { x: 1860, y: 260 }, requiresArea: 'west', lockedMessage: 'The west gate is still blocked. Help Smith Bop finish his first request.' },
    ],
    npcs: [
  ...
  meadow: {
    ...
    exits: [
      { x: 10, y: 10, w: 120, h: 120, to: 'town', spawn: { x: 1370, y: 1380 } },
      { x: 940, y: 1660, w: 220, h: 120, to: 'south_meadow', spawn: { x: 1040, y: 160 }, requiresArea: 'south_meadow', lockedMessage: 'The southern pass is dangerous. Mayor Puffle wants the West Wilds handled first.' },
    ],
  ...
  west: {
    ...
    colorA: '#9ce4be',
    colorB: '#6bb7d8',
    blockers: [rect(420, 260, 300, 210), rect(980, 340, 260, 180), rect(1500, 420, 300, 260), rect(340, 940, 340, 190), rect(1250, 1180, 360, 170)],
    exits: [{ x: 2000, y: 40, w: 160, h: 120, to: 'town', spawn: { x: 220, y: 340 } }],
    npcs: [],
    enemySpawns: [{ type: 'puff_zombie', count: 5, level: 5 }, { type: 'rune_sentinel', count: 5, level: 5 }, { type: 'pocket_drake', count: 5, level: 5 }],
  },
  south_meadow: {
    name: 'South Meadow Kitchen Mire',
    width: 2100,
    height: 1800,
    colorA: '#79d897',
    colorB: '#82b7ff',
    blockers: [rect(420, 360, 280, 170), rect(840, 820, 340, 180), rect(1410, 500, 330, 210), rect(480, 1220, 420, 160)],
    exits: [{ x: 980, y: 20, w: 190, h: 120, to: 'meadow', spawn: { x: 1000, y: 1660 } }],
    npcs: [],
    enemySpawns: [{ type: 'slime', count: 5, level: 5 }, { type: 'chef_slime', count: 1, level: 7 }],
  },
  ruins: {
